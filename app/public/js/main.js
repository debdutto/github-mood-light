...
function drawEvent(data, svg_area) {
    ...
    switch (data.type) {
        case "PushEvent":
            ...
            colorKnob_1 += getRandomInt(0, size)
            colorKnob_2 -= getRandomInt(0, size)
            colorKnob_3 += getRandomInt(0, size)
            break;
    ...
    colorKnob_1 = resetColor(colorKnob_1)
    colorKnob_2 = resetColor(colorKnob_2)
    colorKnob_3 = resetColor(colorKnob_3)

    edit_color = getRGBString(getRandomInt(0, 255), getRandomInt(0, 255), getRandomInt(0, 255))

    var rgbString = getRGBString(colorKnob_1, colorKnob_2, colorKnob_3)
    $('svg').css('background-color', rgbString);
    $('header').css('background-color', rgbString);
